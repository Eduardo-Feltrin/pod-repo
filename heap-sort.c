...
void maxHeapify(int a[], int i){
    ...
    if(leftChild <= sizeof(a)/4 && a[leftChild] > a[i]){ //sizeof recebe o tamanho do vetor e após isso divide por 4 para saber o número de elementos
        maior = leftChild;
    } else {
        maior = i;
    }
